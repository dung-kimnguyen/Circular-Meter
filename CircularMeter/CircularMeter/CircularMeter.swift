...
//
//  Created by Dung Kim Nguyen on 31/07/18.
//  Copyright © 2018 Dung Kim Nguyen. All rights reserved.
//

import UIKit

protocol SSCircularRingMeterDelegate {
    func controlValueUpdated(value: Int)
}

open class SSCircularRingMeter: UIView {
    ...
    var delegate: SSCircularRingMeterDelegate?
...
// MARK: -
// MARK: - Extension
extension SSCircularRingMeter {
    
    // MARK: - Public Methods
    // MARK: -
    
    /// Reset Circular Meter
    public func resetCircularRingMeter() {
        initialSetUp()
    }
    ...
    /// This method sets ring colors for Circular Meter
    ///
    /// - Parameters:
